...
// Confirm .env loaded (don't log sensitive paths in production)
if (process.env.NODE_ENV !== "production") {
  console.log("✅ Loaded .env from:", envPath);
  console.log("🔐 APP_CONFIG_KEYFILE:", process.env.APP_CONFIG_KEYFILE ? "***set***" : "not set");
  console.log("🔐 APP_CONFIG_CERTFILE:", process.env.APP_CONFIG_CERTFILE ? "***set***" : "not set");
}
